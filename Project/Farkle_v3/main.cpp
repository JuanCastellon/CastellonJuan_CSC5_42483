...
int main(int argc, char** argv) {
    ...
    //Check to see if player names are the same
    if(plyr2==plyr1){
        plyr1=plyr2;
    }
    ...
    while(scre1<=10000&&scre2<=10000){
            ...
            //Display the outcome of the dice rolls in columns
